...
func _init_astar() -> void:
	...
	# add every floor cell as a point in the astar
	...
	_astar_connect_points(cells_array, false)

func _astar_connect_points(points_array: Array, connect_diagonals : bool = true) -> void:
