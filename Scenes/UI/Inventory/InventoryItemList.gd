...
func _update_item_display(item_amount: ItemAmount) -> void:
...
func _on_InventoryDataManager_item_removed(item_amount: ItemAmount):
...
func _on_Inventory_hidden_changed(hidden: bool):
	if !hidden:
